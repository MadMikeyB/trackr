...
var normalizeComponent = __webpack_require__(134)
/* script */
...
Component.options.__file = "resources/assets/js/components/Stopwatch.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-48fd5f66", Component.options)
  } else {
    hotAPI.reload("data-v-48fd5f66", Component.options)
  }
 ...
 */
Vue.use(__webpack_require__(160));

Vue.component('stopwatch', __webpack_require__(133));
Vue.component('time-log-list', __webpack_require__(170));
...
var update = __webpack_require__(166)("3d35594a", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-48fd5f66\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Stopwatch.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-48fd5f66\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Stopwatch.vue");
    ...
    methods: {
        ...
        stopTime: function stopTime() {
            ...
            axios.post('/api/logtime/' + this.project.slug, {
                ...
                _this.stopwatch = '00:00:00';
                _this.$emit('time-log-updated', data.timelog);
            });
        },
        incrementTimeElapsed: function incrementTimeElapsed() {
            var _this2 = this;

            this.timer = setInterval(function () {
                _this2.delta = Date.now() - _this2.start;
                _this2.stopwatch = _this2.formatTime(_this2.secondsToTime(_this2.delta / 1000));
                _this2.totalSeconds = Math.floor(_this2.delta / 1000);
            }, 1000);
        },
...
var render = function() {
  ...
  return _c("div", [
    _vm.isCurrentlyLogging
      ? _c("div", [
          _c("span", { staticClass: "stopwatch" }, [
            _vm._v(_vm._s(_vm.stopwatch))
          ])
        ])
      : _vm._e(),
    _vm._v(" "),
    !_vm.isCurrentlyLogging
      ? _c("div", [
          _c(
            "a",
            {
              staticClass: "button button--block button--solid-primary",
              attrs: { href: "#" },
              on: {
      ...
      : _c("div", [
          _c(
            "a",
            {
              staticClass: "button button--block button--solid-secondary",
              attrs: { href: "#" },
              on: {
                click: function($event) {
                  $event.preventDefault()
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-48fd5f66", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/TimeLogList.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-cbc6a8e4", Component.options)
  } else {
    hotAPI.reload("data-v-cbc6a8e4", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Stopwatch__ = __webpack_require__(133);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Stopwatch___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__Stopwatch__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: { Stopwatch: __WEBPACK_IMPORTED_MODULE_0__Stopwatch___default.a },
    mounted: function mounted() {
  ...
  return _c(
    ...
    [
      ...
      _c("stopwatch", {
        ...
        on: { "time-log-updated": _vm.timeLogUpdated }
      }),
      _vm._v(" "),
      this.timelogs.length > 0
        ? _c("div", [
            _c(
              ...
              _vm._l(this.timelogs, function(timelog) {
                return _c("div", [
                  _c("li", { staticClass: "list-group__item" }, [
                    _c("i", { staticClass: "fas fa-clock" }),
                    _vm._v(
                      "\n                " +
                        _vm._s(timelog.number_of_seconds_for_humans) +
                        " on " +
                        _vm._s(
                          _vm._f("moment")(
                            timelog.created_at,
        ...
        : _c("div", [
            _c("p", [
              _vm._v(
                'No time logs have been created. Click the "Log Time" button above to get started.'
              )
            ])
          ])
    ],
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-cbc6a8e4", module.exports)
  }
}
